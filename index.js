...
// ===== PLANS =====  
const plans = {  
  plan1:{name:"1 DAY - 100RS",days:1},  
  plan2:{name:"3 DAY - 200RS",days:3},  
  plan3:{name:"7 DAY - 400RS",days:7},  
  plan4:{name:"15 DAY - 600RS",days:15},  
  plan5:{name:"30 DAY - 800RS",days:30},  
  plan6:{name:"60 DAY - 1200RS",days:60}  
};  
